...
export const PostCard: React.FC<PostCardProps> = ({ post }) => {
  return (
    <Link
      href={`/posts/${post.id}`}
      className="block group cursor-pointer border border-border bg-surface/50 hover:bg-surface p-6 rounded-md transition-all duration-300 hover:border-primary/50 hover:-translate-y-1"
    >
